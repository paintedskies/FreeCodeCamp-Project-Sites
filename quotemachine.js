...
var nature=[];
var life=[];
setup("https://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=40",design);
setup("https://quotes.stormconsultancy.co.uk/quotes.json",computer);
setupnature();
setuplife();
changeTweet();
...
function changeTweet(){
	...
	$("#random").on("click",function(){
		...
		var senturl="https://api.forismatic.com/api/1.0/?method=getQuote&key="+rankey+"&format=json&lang=en";
		$.getJSON(senturl, function(json) {
